...
class BaseCpuModelForm(forms.ModelForm):
...
class CreateCpuModelForm(BaseCpuModelForm):

    class Meta(BaseCpuModelForm.Meta):
        pass


class DeleteCpuModelForm(BaseCpuModelForm):
